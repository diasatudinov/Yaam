...
final class CPShopViewModel: ObservableObject {
    ...
    @Published var shopBgItems: [JGItem] = [
        JGItem(name: "bg1", image: "bgImage1Y", icon: "gameBgIcon1Y", text: "gameBgText1Y", price: 100),
        JGItem(name: "bg2", image: "bgImage2Y", icon: "gameBgIcon2Y", text: "gameBgText2Y", price: 100),
        JGItem(name: "bg3", image: "bgImage3Y", icon: "gameBgIcon3Y", text: "gameBgText3Y", price: 100),
        JGItem(name: "bg4", image: "bgImage4Y", icon: "gameBgIcon4Y", text: "gameBgText4Y", price: 100),
        
    ]
    
    @Published var shopSkinItems: [JGItem] = [
        JGItem(name: "skin1", image: "skinImage1Y", icon: "skinIcon1Y", text: "skinText1Y", price: 100),
        JGItem(name: "skin2", image: "skinImage2Y", icon: "skinIcon2Y", text: "skinText2Y", price: 100),
        JGItem(name: "skin3", image: "skinImage3Y", icon: "skinIcon3Y", text: "skinText3Y", price: 100),
        JGItem(name: "skin4", image: "skinImage4Y", icon: "skinIcon4Y", text: "skinText4Y", price: 100),
    ...
    private let bgKey            = "currentBgY"
    private let boughtBgKey      = "boughtBgY"
    private let skinKey          = "currentSkinY"
    private let boughtSkinKey    = "boughtSkinY"
